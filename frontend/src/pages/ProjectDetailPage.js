...
import {
  ...
  PenTool, Loader2, Zap, CircleDot, Download, Upload
} from 'lucide-react';
    ...
    <div data-testid="project-detail-page" className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="bg-muted">
          ...
          <TabsTrigger value="orchestrator" data-testid="tab-orchestrator"><Zap className="w-4 h-4 mr-1.5" />Orchestrator</TabsTrigger>
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="bg-card border-border"><CardContent className="p-5">
              <p className="text-base text-muted-foreground mb-1">Buget estimat</p>
              <p className="text-2xl font-bold">{project.buget_estimat?.toLocaleString()} RON</p>
            </CardContent></Card>
            <Card className="bg-card border-border"><CardContent className="p-5">
              <p className="text-base text-muted-foreground mb-1">Cheltuieli totale</p>
              <p className="text-2xl font-bold">{project.cheltuieli_totale?.toLocaleString()} RON</p>
            </CardContent></Card>
            <Card className="bg-card border-border"><CardContent className="p-5">
              <p className="text-base text-muted-foreground mb-1">Documente</p>
        ...
        <TabsContent value="navigator" className="space-y-4">
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-4">
              <div className="max-h-[500px] overflow-y-auto space-y-4 min-h-[120px] scroll-smooth" data-testid="chat-history">
